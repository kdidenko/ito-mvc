	...
	public function handleNewUser($actionParams, $requestParams) {
		...
		if (isset ( $requestParams ['submit'] )) {
			...
			if (count ( $error ) == 0) {
				...
				$values = "'" . $requestParams [UsersService::USERNAME] . "','" . $requestParams [UsersService::FIRSTNAME] . "','" . $requestParams [UsersService::LASTNAME] . "','" . $requestParams [UsersService::EMAIL] . "','','" . gmdate ( "Y-m-d H:i:s" ) . "','" . $hash . "','1','TR','" . $path . "'";
